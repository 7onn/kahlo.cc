...
$string['indicator:cognitivedepthdef_help'] = 'O participante alcançou essa porcentagem do engajamento cognitivo oferecido pelas atividades Pesquisa durante esse intervalo de análise (Níveis = Sem visualização, Visualizar, Enviar)';
