...
$string['indicator:cognitivedepthdef_help'] = 'O participante alcançou essa porcentagem do engajamento cognitivo oferecido pelas atividades de Glossário durante esse intervalo de análise (Níveis = Sem visualização, Visualizar, Enviar)';
...
$string['indicator:socialbreadthdef_help'] = 'O participante alcançou essa porcentagem do engajamento social oferecido pelas atividades de Glossário durante esse intervalo de análise (Níveis = Sem participação, Participante único)';
