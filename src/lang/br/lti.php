...
$string['indicator:cognitivedepthdef_help'] = 'O participante alcançou essa porcentagem de engajamento cognitivo oferecido pelas atividades de LTI durante esse intervalo de análise (Níveis = Sem visualizar, Ver, Enviar, Ver feedback)';
...
$string['indicator:socialbreadthdef_help'] = 'O participante alcançou essa porcentagem do engajamento social oferecido pelas atividades LTI durante esse intervalo de análise (Níveis = Sem participação, Participante único, Participante com outras pessoas)';
