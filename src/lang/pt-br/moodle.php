...
$string['adminhelpthemes'] = 'Escolher as características de visualização do site (cores, fontes etc.)';
...
$string['administratordescription'] = 'Administradores podem fazer tudo no sítio, em todos os cursos.';
...
$string['backupmissinguserinfoperms'] = 'Atenção: este backup não contém dados dos usuários. As atividades Exercício e Laboratório de Avaliação não serão incluídas no backup, pois estes módulos não são compatíveis com esse tipo de backup.';
$string['backupnext'] = 'Próximo backup';
$string['backupnonisowarning'] = 'Atenção: este backup é de um sistema com versão de Moodle anterior à 1.6 (não Unicode). Se este backup contém textos que não são ISO-8859-1, eles podem ser CORROMPIDOS se forem restaurados nesta versão do Moodle, que é Unicode. Consulte <a href="http://docs.moodle.org/en/Backup_FAQ">Backup FAQ</a> para mais informações sobre como recuperar este backup corretamente.';
