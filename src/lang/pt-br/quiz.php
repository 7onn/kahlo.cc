...
$string['completiondetail:minattempts'] = 'Faça tentativas: {$a}';
$string['completiondetail:passgrade'] = 'Receber uma nota de aprovação';
$string['completiondetail:passorexhaust'] = 'Receba uma nota de aprovação ou conclua todas as tentativas disponíveis';
