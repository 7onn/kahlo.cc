...
$string['duplicatetour'] = 'Duplicar tour';
...
$string['filter_accessdate_enabled_help'] = 'Mostrar o tour apenas para usuários novos ou usuários que acessaram o site recentemente';
$string['filter_category'] = 'Categoria';
$string['filter_category_help'] = 'Mostrar o tour em uma página associada a um curso na categoria selecionada.';
