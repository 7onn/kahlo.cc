...
$string['indicator:cognitivedepthdef_help'] = 'O participante alcançou essa porcentagem do engajamento cognitivo oferecido pelas atividades Laboratório de Avaliação durante esse intervalo de análise (Níveis = Sem visualização, Visualizar, Enviar, Visualizar feedback, Comentário no feedback, Reenviar após visualizar o feedback)';
