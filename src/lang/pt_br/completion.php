...
$string['areyousureoverridecompletion'] = 'Você tem certeza que quer sobrescrever o atual estado de conclusão dessa atividade, para este usuário, e marcá-la como "{$a}"?';
...
<strong>Com condição:</strong> Mostrar a atividade como concluída quando a(s) condição(ões) for(em) atendida(s)';
