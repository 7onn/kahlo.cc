...
$string['completiondetail:discussions'] = 'Comece as discussões: {$a}';
...
$string['indicator:cognitivedepthdef_help'] = 'O participante alcançou esta porcentagem da capacidade cognitiva oferecida pelas atividades Fórum durante esse intervalo de análise (Níveis = Não visualizado, Visualizado, Submetido, Feedback visualizado, Comentários ao feedback, Submeter novamente após visualizar feedback)';
...
$string['indicator:socialbreadthdef_help'] = 'O participante alcançou esta porcentagem do relacionamento social oferecido pelas atividades Fórum durante esse intervalo de análise (Níveis = Sem participação, Participante individual, Participante com outros)';
$string['inforum'] = 'em {$a}';
...
$string['postisprivatereply'] = 'Esta é uma resposta privada. Não é visível para outros participantes.';
