...
$string['pluginname_help'] = 'As questões para selecionar palavras que faltam exigem que o respondente selecione as respostas corretas nos menus suspensos. [[1]], [[2]], [[3]], ... são usados como marcadores no texto da questão, com as respostas corretas definidas como opções de resposta 1, 2, 3, ... respectivamente. Opções extras de respostas podem ser adicionadas para tornar a questão mais difícil. As opções de respostas podem ser agrupadas para controlar as disponíveis em cada menu de opções.';
